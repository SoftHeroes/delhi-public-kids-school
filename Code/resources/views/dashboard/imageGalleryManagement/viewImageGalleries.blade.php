...
<div class="app-title">
	<div>
		<h1><i class="fas fa-table"></i> View Image Galleries</h1>
	</div>
				...
				<table class="table table-hover table-bordered" id="myTable">
					...
					<tbody>
						...
						<tr class="text-center">
							...
							<td>
								<a class="btn btn-primary btn-delete" href="{!! route('deleteImageGallery',$currentimageGallery->uniqueID) !!}">Delete</a>
							</td>
                        </tr>
                        @endforeach
                        @endisset
