	...
	<div class="col-md-12">
		<div class="tile">
			<div class="tile-body col-md-12">
				<h3 class="tile-title">Create Slider</h3>
				{{-- Error Message Code --}}
				...
				<form class="row" action="{!! route('createSlider') !!}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group col-md-6">
						...
						<input class="form-control" maxlength="50" name="title" type="text" placeholder="Silder Title">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputFile">Slider Image</label>
                        <input class="form-control-file" name="files[]" id="files" required="required" type="file"accept=".jpg,.jpeg,.png"><small class="form-text text-muted" id="fileHelp">This image will show as slider image in website. And try to Upload All Images 1440 x 480 px.</small>
                    </div>
                    <div class="col-md-12">
                        <br>
                    </div>
